...
z_data_1 = -1.0/np.sqrt((x_data-0.5)**2 + y_data**2)
z_data_2 = 1.5/np.sqrt((x_data+0.5)**2 + y_data**2)
z_data_3 = -1.0/np.sqrt(x_data**2 + (y_data-0.5)**2)
z_data_4 = 0.5/np.sqrt((x_data-0.5)**2 + (y_data+0.5)**2)
z_data = z_data_1 + z_data_2 + z_data_3    + z_data_4
